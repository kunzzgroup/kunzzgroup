...
<head>
    ...
    <style>
        * {
        ...
        /* 响应式表格列宽 - 11列设置 */
        .excel-table th:nth-child(1), .excel-table td:nth-child(1) { width: 9%; }   /* 第1列 - 日期 */
        .excel-table th:nth-child(2), .excel-table td:nth-child(2) { width: 7%; }  /* 第2列 - 时间 */
        .excel-table th:nth-child(3), .excel-table td:nth-child(3) { width: 9%; }  /* 第3列 - 产品编号 */
        .excel-table th:nth-child(4), .excel-table td:nth-child(4) { width: 16%; }  /* 第4列 - 产品名字 */
        .excel-table th:nth-child(5), .excel-table td:nth-child(5) { width: 10%; }  /* 第5列 - 规格 */
        .excel-table th:nth-child(6), .excel-table td:nth-child(6) { width: 10%; }  /* 第6列 - 货物类型 */
        .excel-table th:nth-child(7), .excel-table td:nth-child(7) { width: 11%; }  /* 第7列 - 供应商 */
        .excel-table th:nth-child(8), .excel-table td:nth-child(8) { width: 9%; }  /* 第8列 - 申请人 */
        .excel-table th:nth-child(9), .excel-table td:nth-child(9) { width: 9%; }  /* 第9列 - 批准状态 */
        .excel-table th:nth-child(10), .excel-table td:nth-child(10) { width: 7%; }  /* 第10列 - 状态 */
            ...
            try {
                ...
                for (const row of rows) {
                    ...
                    if (!rowData.date || !rowData.time || !rowData.product_code || 
                        !rowData.product_name || !rowData.specification || !rowData.category || 
                        !rowData.supplier || !rowData.applicant) {
                        continue; // 跳过不完整的行
                    }
