...
<head>
    ...
    <link rel="stylesheet" href="css/j1stocklist.css?v=<?php echo time(); ?>">
</head>
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="filter-section">
                <div class="filter-grid">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="smartSearchWrapper">
                            <i class="fas fa-search smartSearch-icon"></i>
                            <input type="text" id="spec-filter" class="smartSearch-input" placeholder="搜索规格单位...">
                        </div>
                    </div>
                </div>
    ...
    <script src="js/j1stocklist.js?v=<?php echo time(); ?>"></script>
</body>
</html>
