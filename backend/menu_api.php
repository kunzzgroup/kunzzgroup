...
//  POST menu_api.php?action=reorder_items
//  Body: ids (comma-separated string e.g. "1,2,5,3")
// ============================================================
...
//  POST menu_api.php?action=reorder_cats
//  Body: ids (comma-separated string)
// ============================================================
...
//  GET menu_api.php?action=get_item&id=123
// ============================================================
function actionGetItem(): void {
    ...
    $pdo  = getDB();
    $stmt = $pdo->prepare("SELECT m.*, mc.category_name 
                           FROM menus m 
                           LEFT JOIN menu_categories mc ON mc.id = m.category_id 
                           WHERE m.id = ?");
    $stmt->execute([$id]);
