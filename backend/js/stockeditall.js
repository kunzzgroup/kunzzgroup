...
document.addEventListener('keydown', function (e) {
    // Ctrl+A+Enter 批量保存
    if (e.ctrlKey && e.key === 'Enter' && e.code === 'Enter' && (e.getModifierState('CapsLock') ? !e.shiftKey : e.shiftKey || e.altKey || window._isAHeld)) {
        // This is a bit complex to detect Ctrl+A+Enter reliably because 'A' might be pressed before 'Enter'
        // Let's use a simpler approach: check if 'A' is currently pressed
    }
