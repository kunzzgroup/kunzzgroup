...
<head>
    ...
    <link rel="stylesheet" href="css/j1stockproductname.css?v=<?php echo time(); ?>">
</head>
<body>
            ...
            <div class="controls">
                ...
                <div class="system-selector">
                    <button class="selector-button" onclick="toggleSystemSelector()">
                        <span id="current-system">J1</span>
                        <i class="fas fa-chevron-down"></i>
                    </button>
                    <div class="selector-dropdown" id="system-selector-dropdown">
                        ...
                        <div class="dropdown-item active" onclick="switchSystem('j1')">J1</div>
   ...
   <script src="js/j1stockproductname.js?v=<?php echo time(); ?>"></script>
</body>
</html>
