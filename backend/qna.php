        ...
        <div class="qna-container">
            ...
            <form id="qnaForm" class="edit-mode">
                ...
                <div class="button-group">
                    ...
                    <button type="submit" class="btn btn-submit" id="submitBtn">提交问卷</button>
                </div>
            </form>
            ...
            <div class="view-mode">
                ...
                <div class="button-group">
                    <button type="button" class="btn btn-print" onclick="generatePDF()">打印问卷</button>
                </div>
            </div>
        </div>
    </div>
