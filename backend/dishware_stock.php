    ...
    <script>
        ...
        function addNewTransferRow(shopType) {
            ...
            row.innerHTML = `
                ...
                <td class="text-center">
                    <select class="transfer-to-select" id="${rowId}-to" style="width: calc(100% + 8px); min-width: 80px; padding: 4px 8px; border: none; background: transparent; text-align: center; outline: none; font-size: clamp(8px, 0.74vw, 14px);">
        ...
        function editTransferRecord(recordId, shopId) {
            ...
            toCell.innerHTML = `
                <select class="transfer-to-select-edit" id="${codeRowId}-to" style="width: calc(100% + 8px); min-width: 80px; padding: 4px 8px; border: none; background: transparent; text-align: center; outline: none; font-size: clamp(8px, 0.74vw, 14px);">
                    <option value="">选择餐厅</option>
                    ${restaurantOptions}
                </select>
            `;
