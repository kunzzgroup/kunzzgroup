    ...
    <div id="permissionsModal" class="modal">
        <div class="modal-content" style="max-width: 950px !important; width: 70vw !important;">
            ...
            <div class="modal-body">
                ...
                <!-- 权限配置布局 -->
                                            <div class="clean-perm-tree">
                                <!-- 集团架构 -->
                                <details class="perm-group" open>
                                    <summary><input type="checkbox" class="perm-parent" value="brand"> 集团架构</summary>
                                    <div class="perm-children">
                                        <details class="perm-subgroup">
                                            <summary><input type="checkbox" class="perm-child" data-parent="brand" value="kunzz_holdings"> KUNZZ HOLDINGS SDN BHD</summary>
                                            <div class="perm-grandchildren">
                                                <label><input type="checkbox" class="perm-grandchild perm-page-blueprint" data-brand="kunzz_holdings" value="blueprint"> 企业蓝图</label>
                                            </div>
                                        </details>
                                        <details class="perm-subgroup">
                                            <summary><input type="checkbox" class="perm-child" data-parent="brand" value="tokyo_cuisine"> TOKYO JAPANESE CUISINE SDN BHD</summary>
                                            <div class="perm-grandchildren">
                                                <label><input type="checkbox" class="perm-grandchild perm-page-schedule" data-store="j1" data-brand="tokyo_cuisine" value="schedule"> J1 (Midvalley Southkey)排班表</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-page-schedule" data-store="j2" data-brand="tokyo_cuisine" value="schedule"> J2 (Paradigm Mall)排班表</label>
                                            </div>
                                        </details>
                                        <details class="perm-subgroup">
                                            <summary><input type="checkbox" class="perm-child" data-parent="brand" value="tokyo_izakaya"> TOKYO IZAKAYA SDN BHD</summary>
                                            <div class="perm-grandchildren">
                                                <label><input type="checkbox" class="perm-grandchild perm-page-schedule" data-store="j3" data-brand="tokyo_izakaya" value="schedule"> J3 (Desa Tebrau)排班表</label>
                                            </div>
                                        </details>
                                    </div>
                                </details>
                                ...
                                <!-- 营收数据 -->
                                <details class="perm-group" open>
                                    <summary><input type="checkbox" class="perm-parent" value="analytics"> 营收数据</summary>
                                    <div class="perm-children">
                                        <label class="perm-item-row"><input type="checkbox" class="perm-child" data-parent="analytics" value="kpi_report"> KPI报表</label>
                                        <details class="perm-subgroup">
                                            <summary><input type="checkbox" class="perm-child" data-parent="analytics" value="kpi_upload"> 数据上传</summary>
                                            <div class="perm-grandchildren">
                                                <div class="perm-grandchild-title">系统选项</div>
                                                <label><input type="checkbox" class="perm-grandchild perm-upload-system" value="j1"> J1</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-upload-system" value="j2"> J2</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-upload-system" value="j3"> J3</label>
                                                <div class="perm-grandchild-title">上传类型</div>
                                                <label><input type="checkbox" class="perm-grandchild perm-upload-type" value="kpi"> KPI</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-upload-type" value="cost"> 成本</label>
                                            </div>
                                        </details>
                                    </div>
                                </details>
                                ...
                                <!-- 人事管理 -->
                                <details class="perm-group" open>
                                    <summary><input type="checkbox" class="perm-parent" value="hr"> 人事管理</summary>
                                    <div class="perm-children">
                                        <label class="perm-item-row"><input type="checkbox" class="perm-child" data-parent="hr" value="staff_management"> 职员管理</label>
                                    </div>
                                </details>

                                <!-- 资源总库 -->
                                <details class="perm-group" open>
                                    <summary><input type="checkbox" class="perm-parent" value="resource"> 资源总库</summary>
                                    <div class="perm-children">
                                        <details class="perm-subgroup">
                                            <summary><input type="checkbox" class="perm-child" data-parent="resource" value="stock_inventory"> 库存</summary>
                                            <div class="perm-grandchildren">
                                                <div class="perm-grandchild-title">系统选项</div>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-system" value="central"> 中央</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-system" value="j1"> J1</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-system" value="j2"> J2</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-system" value="j3"> J3</label>
                                                <div class="perm-grandchild-title">视图选项</div>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-view" value="list"> 总库存</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-view" value="records"> 进出货</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-view" value="remark"> 货品备注</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-view" value="product"> 货品种类</label>
                                                <label><input type="checkbox" class="perm-grandchild perm-stock-view" value="sot"> 货品异常</label>
                                            </div>
                                        </details>
                                        <label class="perm-item-row"><input type="checkbox" class="perm-child" data-parent="resource" value="dishware"> 碗碟</label>
                                        <label class="perm-item-row"><input type="checkbox" class="perm-child" data-parent="resource" value="price_comparison"> 价格对比</label>
                                    </div>
                                </details>

                                <!-- 视觉管理 -->
                                <details class="perm-group" open>
                                    <summary><input type="checkbox" class="perm-parent" value="visual"> 视觉管理</summary>
                                </details>
                            </div>
