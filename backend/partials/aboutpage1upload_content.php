<?php
$uploadActionUrl = isset($uploadActionUrl) ? $uploadActionUrl : 'aboutpage1upload.php';
$returnTo = isset($returnTo) ? $returnTo : '';
$mediaEntry = $config['about_background'] ?? null;
?>
<div class="container" data-aboutpage1-content-root>
    <div class="header">
        <h1>关于我们页面管理</h1>
    </div>
    ...
    <div class="content">
        ...
        <div class="media-section">
            ...
            <form id="aboutpage1-upload-form" method="post" enctype="multipart/form-data" class="upload-form" action="<?php echo htmlspecialchars($uploadActionUrl, ENT_QUOTES, 'UTF-8'); ?>">
                ...
                <div class="form-group">
                    ...
                    <?php if ($mediaEntry): ?>
                        <?php
                        $mediaSrc = aboutpage1upload_resolveMediaSrc($mediaEntry['file']);
                        $mediaVersion = aboutpage1upload_mediaVersion($mediaEntry['file']);
                        ?>
