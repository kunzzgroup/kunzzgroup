<div class="container" data-supply-content-root>
    <div class="header">
        <h1>供应商价格对比</h1>
    ...
    <div class="filter-section">
        <div class="filter-grid">
            <div class="filter-left">
                <div class="filter-group header-search" style="flex: 0 0 180px;">
                    <label>搜索</label>
                    <div class="smartSearchWrapper">
                        <i class="fas fa-search smartSearch-icon"></i>
                        <input type="text" id="search-input" class="smartSearch-input" placeholder="输入材料名称" style="text-transform: uppercase;">
                    </div>
                </div>
