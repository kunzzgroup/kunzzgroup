...
<body>
        ...
        <div id="export-modal" class="export-modal">
            <div class="export-modal-content">
                ...
                <div class="export-form-group">
                    ...
                    <small style="color: #6b7280; font-size: 12px;">格式示例：J3-2510-001（店面-年月-序号）</small>
                </div>
    ...
    <script>
        ...
        function switchStock(stockType, event = null) {
            ...
            const activeItem = document.querySelector(`.selector-dropdown .dropdown-item[data-type="j3"]`);
        ...
        async function saveNewRowRecord(buttonElement, skipTableRefresh = false) {
            ...
            if (formData.out_quantity > 0) {
                ...
                if (!targetInput || !targetInput.value) {
                    const errorMsg = '当有出库数量时，请选择目标系统（J3）';
                    if (!skipTableRefresh) {
                        showAlert(errorMsg, 'error');
                    }
                    throw new Error(errorMsg);
        ...
        async function saveNewRecord() {
            ...
            if (formData.out_quantity > 0) {
                ...
                if (!targetSystem) {
                    showAlert('当有出库数量时，请选择目标系统（J3）', 'error');
                    return;
                }
    ...
    <script>
        ...
        async function confirmExport() {
            ...
            try {
                ...
                const useMultiPage = (exportSystem === 'j3' && recordCount > 24);
                
                if (useMultiPage) {
                    // 使用多页模板
                    const pageCount = Math.ceil(recordCount / 24);
        ...
        // 生成发票号码 - 格式：J3-2510-001（店面-年月-序号）
