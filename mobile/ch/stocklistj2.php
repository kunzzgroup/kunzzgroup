    ...
    <script>
        ...
        async function saveRecord(id) {
            ...
            try {
                ...
                // ★ 先从数据库获取真实库存（不依赖前端缓存的 original_qty，不按规格/编号过滤）
                const stockByPriceUrl = `${STOCK_EDIT_API}?action=product_stock_by_price&product_name=${encodeURIComponent(record.product_name)}`;
