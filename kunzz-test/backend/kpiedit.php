            ...
            <div class="controls">
                ...
                <div class="restaurant-selector">
                    ...
                    <div class="number-dropdown">
                        <button class="number-btn dropdown-toggle"<?php if ($showRestaurantDropdown): ?> onclick="toggleNumberDropdown()"<?php
                        ...
                        <div class="number-dropdown-menu" id="number-dropdown"<?php if (!$showRestaurantDropdown): ?> style="display:none;"<?php
endif; ?>>
                            <?php if ($showRestaurantDropdown): ?>
...
<script>
window.KPI_CONFIG = {
    API_BASE_URL: 'kpiapi.php',
    availableReportTypes: <?php echo json_encode($reportPermissions, JSON_UNESCAPED_UNICODE); ?>,
    reportDropdownEnabled: <?php echo $showReportDropdown ? 'true' : 'false'; ?>,
    availableRestaurants: <?php echo json_encode($restaurantPermissions, JSON_UNESCAPED_UNICODE); ?>,
    restaurantDropdownEnabled: <?php echo $showRestaurantDropdown ? 'true' : 'false'; ?>,
    restaurantConfig: <?php echo json_encode($restaurantConfigAllowed, JSON_UNESCAPED_UNICODE); ?>,
