...
<head>
    ...
    <link rel="stylesheet" href="../css/stockedit.css?v=<?php echo time(); ?>">
</head>
<body>
    <div class="container">
        <div class="header">
        ...
        <div id="add-form" class="add-form">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="add-in-qty" class="form-input" min="0" step="0.01" placeholder="0" oninput="handleAddFormOutQuantityChange()">
                </div>
                <div class="form-group">
                    <label for="add-out-qty">出库数量</label>
                    <input type="number" id="add-out-qty" class="form-input" min="0" step="0.01" placeholder="0" oninput="handleAddFormOutQuantityChange()">
                </div>
                <div class="form-group">
