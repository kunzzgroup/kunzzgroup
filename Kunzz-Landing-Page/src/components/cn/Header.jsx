...
export default function Header({ activeSlide = 0, onSlideTo, totalSlides = 4 }) {
  ...
  const isAboutPage = location.pathname === aboutPath;
  const isJoinPage = location.pathname === joinPath;
    ...
    <>
      <header className="header-navbar">
        ...
        >
          ...
          >
            <span
              ...
              onKeyDown={(e) => e.key === 'Enter' && toggleBrands(e)}
            >
              旗下品牌
            </span>
            <div
              className={`header-nav-dropdown-menu${brandsOpen ? ' show' : ''}`}
              id="brandsNavDropdownMenu"
            >
              <a
                href="https://tokyo.kunzzgroup.com/tokyo"
                className="header-nav-dropdown-item"
              >
                Tokyo Japanese Cuisine
              </a>
              <a
                href="https://izakaya.kunzzgroup.com"
                className="header-nav-dropdown-item"
              >
        ...
        <div ref={rightRef} className="header-right-section">
          ...
          <div className="header-language-switch" aria-label="选择语言">
            <a
              href="/"
