...
echo "<hr>";
echo "<h2>快速链接</h2>";
echo "<p><a href='../resource/dishware_index' style='color: blue;'>🏠 系统首页</a></p>";
echo "<p><a href='../visual/dishware_upload' style='color: blue;'>📤 上传碗碟信息</a></p>";
echo "<p><a href='../resource/dishware_stock' style='color: blue;'>📊 库存管理</a></p>";
