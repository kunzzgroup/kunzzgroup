// Center Stock Product Name JS

// API Configuration
const API_BASE_URL = '../api/stockapi.php';
const SYSTEM_TYPE = 'Central';  // 当前系统类型
...
async function loadStockData() {
    ...
    try {
        ...
        params.append('system_assign', SYSTEM_TYPE);  // 自动过滤中央系统数据
    ...
    row.innerHTML = `
        ...
        <td>
            <select class="excel-select readonly" data-field="system_assign" data-row="${rowId}" disabled>
                <option value="Central" selected>中央</option>
            </select>
        </td>
...
function addNewRow() {
    ...
    const newData = {
        ...
        supplier: '',
        applicant: '',
        system_assign: SYSTEM_TYPE,  // 自动设置为中央系统
        approver: ''
    };
...
function extractRowData(row) {
    ...
    if (typeof CURRENT_USER_APPLICANT !== 'undefined') {
