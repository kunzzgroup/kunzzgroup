<link rel="stylesheet" href="/backendtest/core/css/sidebar.css">
<script src="/backendtest/core/js/sidebar.js" defer></script>
    ...
    <div class="informationmenu-content">
                ...
                <div class="menu-item-wrapper">
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            <a href="/backendtest/pages/corporate_blueprint.php" class="submenu-item">企业蓝图</a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            ...
                            <div class="sub-options" id="j1-options">
                                ...
                                <a href="/backendtest/modules/schedule_manager.php?restaurant=J1" class="sub-option">员工排班表</a>
                                <a href="/backendtest/modules/phone_manage.php?restaurant=J1" class="sub-option">员工手机记录</a>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="sub-options" id="j2-options">
                                ...
                                <a href="/backendtest/modules/schedule_manager.php?restaurant=J2" class="sub-option">员工排班表</a>
                                <a href="/backendtest/modules/phone_manage.php?restaurant=J2" class="sub-option">员工手机记录</a>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            ...
                            <div class="sub-options" id="j3-options">
                                ...
                                <a href="/backendtest/modules/schedule_manager.php?restaurant=J3" class="sub-option">员工排班表</a>
                                <a href="/backendtest/modules/phone_manage.php?restaurant=J3" class="sub-option">员工手机记录</a>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </div>
        ...
        <div class="informationmenu-section">
            ...
            <div class="dropdown-menu-items" id="analytics-items">
                ...
                <div class="menu-item-wrapper">
                    <a href="/backendtest/modules/kpi.php" class="informationmenu-item">
                        KPI报表
                    </a>
                </div>
                <?php endif; ?>
        ...
        <div class="informationmenu-section">
            ...
            <div class="dropdown-menu-items" id="hr-items">               
                ...
                <div class="menu-item-wrapper">
                    <a href="/backendtest/modules/generatecode.php" class="informationmenu-item">
                        职员管理
                    </a>
                </div>
                <div class="menu-item-wrapper">
                    <a href="/backendtest/modules/qna.php" class="informationmenu-item">
                        问卷回答
                    </a>
                </div>
                <div class="menu-item-wrapper">
                    <a href="/backendtest/modules/evaluation_form.php" class="informationmenu-item">
                        考核表单
                    </a>
                </div>
                <?php endif; ?>
        ...
        <div class="informationmenu-section">
            ...
            <div class="dropdown-menu-items" id="photoupload-items">
                <div class="menu-item-wrapper">
                    <a href="/backendtest/cms/bgmusicupload.php" class="informationmenu-item">
                        背景音乐
                    </a>
                </div>
                <div class="menu-item-wrapper">
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            <a href="/backendtest/cms/homepage1upload.php" class="submenu-item">第一页</a>
                        </div>
                    </div>
                </div>
                <div class="menu-item-wrapper">
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            <a href="/backendtest/cms/aboutpage1upload.php" class="submenu-item">第一页</a>
                            <a href="/backendtest/cms/aboutpage4upload.php" class="submenu-item">第四页</a>
                        </div>
                    </div>
                </div>
                <div class="menu-item-wrapper">
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            <a href="/backendtest/cms/tokyopage1upload.php" class="submenu-item">第一页</a>
                            <a href="/backendtest/cms/tokyopage5upload.php" class="submenu-item">第五页</a>
                        </div>
                    </div>
                </div>
                <div class="menu-item-wrapper">
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            <a href="/backendtest/core/templates/joinpage1upload.php" class="submenu-item">第一页</a>
                            <a href="/backendtest/core/templates/joinpage2upload.php" class="submenu-item">第二页</a>
                            <a href="/backendtest/core/templates/joinpage3upload.php" class="submenu-item">第三页</a>
                        </div>
                    </div>
                </div>
                <div class="menu-item-wrapper">
                    <a href="/backendtest/cms/corporate_blueprint_edit.php" class="informationmenu-item">
                        企业蓝图管理
                    </a>
                </div>
            </div>
        ...
        <div class="informationmenu-footer">
            <button class="logout-btn" onclick="location.href='/backendtest/core/logout.php'">
                登出
            </button>
        </div>
    </div>
