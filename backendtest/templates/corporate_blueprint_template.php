...
<body>
    ...
    <div id="corporate-data" 
         style="display: none;"
         data-org-chart='<?php echo json_encode($orgChartData, JSON_UNESCAPED_UNICODE); ?>'
         data-internal-org='<?php echo json_encode($internalOrgChartData, JSON_UNESCAPED_UNICODE); ?>'
         data-objectives='<?php echo json_encode($allObjectives, JSON_UNESCAPED_UNICODE); ?>'>
    </div>
