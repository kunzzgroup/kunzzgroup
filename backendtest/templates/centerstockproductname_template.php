...
<head>
    ...
    <link href="../css/centerstockproductname.css" rel="stylesheet">
</head>
<body>
    ...
    <script>
        ...
        const CURRENT_USER_APPLICANT = "<?php echo isset($_SESSION['username']) ? $_SESSION['username'] : ''; ?>";
    </script>
    <script src="../js/centerstockproductname.js"></script>
</body>
</html>
