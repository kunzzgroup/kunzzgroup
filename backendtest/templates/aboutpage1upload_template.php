        ...
        <div class="content">           
            ...
            <div class="media-section">
                ...
                <form method="post" enctype="multipart/form-data" class="upload-form">
                    ...
                    <input type="hidden" name="upload_dir" value="../images/images/">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (isset($config['about_background'])): ?>
                            <div class="current-file">
                                <strong>当前文件:</strong> <?php echo htmlspecialchars(basename($config['about_background']['file'])); ?><br>
                                <small>类型: <?php echo htmlspecialchars($config['about_background']['type']); ?> | 更新时间: <?php echo htmlspecialchars($config['about_background']['updated']); ?></small>
                                
                                <div class="preview-container">
                                    <?php if ($config['about_background']['type'] === 'video'): ?>
                                        <video class="preview-video" controls>
                                            <source src="<?php echo htmlspecialchars($config['about_background']['file']); ?>" type="video/mp4">
                                        </video>
                                    <?php else: ?>
                                        <img class="preview-image" src="<?php echo htmlspecialchars($config['about_background']['file']); ?>" alt="当前背景">
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
