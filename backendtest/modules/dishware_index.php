    ...
    <div class="container">
        ...
        <div class="card-grid">
            <div class="card">
                ...
                <a href="../cms/dishware_upload.php" class="card-btn">
            ...
            <div class="card">
                ...
                <a href="../modules/dishware_stock.php" class="card-btn">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('keydown', function(e) {
                if (e.key === '1') {
                    document.querySelector('a[href="../cms/dishware_upload.php"]').click();
                } else if (e.key === '2') {
                    document.querySelector('a[href="../modules/dishware_stock.php"]').click();
                }
            });
        });
    </script>
