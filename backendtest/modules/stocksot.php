...
<head>
    ...
    <link rel="stylesheet" href="../css/stocksot.css">
...
<body>
    ...
    <script>
        const API_BASE_URL = '/kunzzgroup/backendtest/api/stocksotapi.php';
        const PRODUCT_API_URL = '/kunzzgroup/backendtest/api/stockapi.php';
        const PRICE_API_URL = '/kunzzgroup/backendtest/api/stockeditapi.php';  // 价格API使用stockeditapi
