...
<body>
    <div class="container">
        ...
        <div class="content">
            <a href="../pages/dashboard.php" class="back-btn">← 返回仪表板</a>
            ...
            <div class="media-section">
                <h2>背景音乐管理</h2>
                <div class="page-grid">
                    <a href="../cms/bgmusicupload.php" class="page-card">
            ...
            <div class="media-section">
                <h2>首页管理</h2>
                <div class="page-grid">
                    <a href="../cms/homepage1upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>首页第一页</h3>
                        <p>管理首页背景视频/图片</p>
                        <span class="page-arrow">→</span>
            ...
            <div class="media-section">
                <h2>关于我们管理</h2>
                <div class="page-grid">
                    <a href="../cms/aboutpage1upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>关于我们第一页</h3>
                        <p>管理封面背景图片</p>
                        <span class="page-arrow">→</span>
                    </a>
                    <a href="../cms/aboutpage4upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>关于我们第四页</h3>
                        <p>管理发展历史图片</p>
                        <span class="page-arrow">→</span>
            ...
            <div class="media-section">
                <h2>旗下品牌管理</h2>
                <div class="page-grid">
                    <a href="../cms/tokyopage1upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>Tokyo 首页背景</h3>
                        <p>管理品牌页面首页背景图片</p>
                        <span class="page-arrow">→</span>
                    </a>
                    <a href="../cms/tokyopage5upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>Tokyo 位置信息</h3>
                        <p>管理总店分店地址电话信息</p>
                        <span class="page-arrow">→</span>
            ...
            <div class="media-section">
                <h2>加入我们管理</h2>
                <div class="page-grid">
                    <a href="../cms/joinpage1upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>加入我们页面</h3>
                        <p>管理招聘页面图片</p>
                        <span class="page-arrow">→</span>
                    </a>
                    <a href="../cms/joinpage2upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>我们的足迹照片</h3>
                        <p>管理34张公司活动照片</p>
                        <span class="page-arrow">→</span>
                    </a>
                    <a href="../cms/joinpage3upload.php" class="page-card">
                        <div class="page-icon"></div>
                        <h3>招聘资料</h3>
                        <p>管理招聘职位</p>
                        <span class="page-arrow">→</span>
