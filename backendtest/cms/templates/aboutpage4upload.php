        ...
        <div class="content">           
            ...
            <div class="timeline-section">
                ...
                <div class="timeline-content <?php echo $year == '2022' ? 'active' : ''; ?>" id="content-<?php echo $year; ?>">
                    ...
                    <div class="entry-container" data-record-id="<?php echo htmlspecialchars($recordId); ?>">
                        <div class="entry-header">
                            <h4><?php echo $isEnglish ? 'Record' : '记录'; ?> #<?php echo $entryIndex; ?><?php echo $data['month'] ? ' · ' . ($isEnglish ? 'Month ' . (int)$data['month'] : (int)$data['month'] . '月') : ''; ?></h4>
                            <button type="button" class="btn btn-danger btn-delete" onclick="confirmDeleteRecord('<?php echo $recordId; ?>')">
